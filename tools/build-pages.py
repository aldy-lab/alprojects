...
PROJECTS = """
    ...
    <div class="container">
      ...
      <ul class="kp-list">
        ...
        <li class="kp-row">
          <span class="kp-num">05</span>
          <span class="kp-name">GE Renewable Energy — MERCUR</span>
          <span class="kp-scope">Deployment of 30 TIG welders for nacelle reinforcement works.</span>
        </li>
      </ul>
    </div>
