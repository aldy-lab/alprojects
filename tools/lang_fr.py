...
S = {
    ...
    'Certified specialist performing welding works':
        'Spécialiste certifié réalisant des travaux de soudage',
    ...
    'We take the scope.<br>We also prove the work.':
        'Nous prenons le périmètre.<br>Nous prouvons aussi le travail.',
    ...
    'Integrated Inspection<br>&amp; Access Services':
        'Inspection intégrée<br>&amp; services d’accès',
    ...
    'ALPROJECTS, UAB — Šilutės av. 2-536, LT-91110 Klaipėda, Lithuania':
        'ALPROJECTS, UAB — Šilutės av. 2-536, LT-91110 Klaipėda, Lituanie',
    ...
    'ALPROJECTS, UAB<br> Šilutės av. 2-536<br> LT-91110 Klaipėda<br> Lithuania':
        'ALPROJECTS, UAB<br> Šilutės av. 2-536<br> LT-91110 Klaipėda<br> Lituanie',
    ...
    'Contact ALPROJECTS Group — Šilutės av. 2-536, Klaipėda, Lithuania. Project enquiries and personnel requests.':
        'Contacter ALPROJECTS Group — Šilutės av. 2-536, Klaipėda, Lituanie. Demandes de projet et de personnel.',
    ...
    '<span class="value" data-count="10" data-suffix="+">0+</span> <span class="label">Projects delivered across multiple countries</span>':
        '<span class="value" data-count="10" data-suffix="+">0+</span> <span class="label">Projets livrés dans plusieurs pays</span>',
    ...
    'ALPROJECTS, UAB<br>Šilutės av. 2-536, LT-91110 Klaipėda, Lithuania<br> <a href="mailto:info@alprojects.eu">info@alprojects.eu</a> &middot; <a href="tel:+37063663744">+370 636 63 744</a>':
        'ALPROJECTS, UAB<br>Šilutės av. 2-536, LT-91110 Klaipėda, Lituanie<br> <a href="mailto:info@alprojects.eu">info@alprojects.eu</a> &middot; <a href="tel:+37063663744">+370 636 63 744</a>',
    ...
    'The company employs between 51 and 200 people and works across multiple European countries. Projects are resourced from a pool of certified specialists rather than subcontracted on, which is what keeps the quality system meaningful.':
        'L’entreprise emploie entre 51 et 200 personnes et intervient dans plusieurs pays européens. Les projets sont dotés à partir d’un vivier de spécialistes certifiés plutôt que sous-traités : c’est ce qui donne sa portée réelle au système qualité.',
    ...
    'Send your CV and certificates to <a href="mailto:info@alprojects.eu?subject=CV%20and%20certificates">info@alprojects.eu</a> or by <a href="https://wa.me/37063663744" target="_blank" rel="noopener">WhatsApp</a>, with the same name you give above.':
        'Envoyez votre CV et vos certificats à <a href="mailto:info@alprojects.eu?subject=CV%20and%20certificates">info@alprojects.eu</a> ou par <a href="https://wa.me/37063663744" target="_blank" rel="noopener">WhatsApp</a>, sous le même nom que celui indiqué ci-dessus.',
