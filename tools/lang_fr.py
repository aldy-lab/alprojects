...
S = {
    ...
    'Ten scopes, photographed as they were built.':
        'Dix chantiers, photographiés pendant leur exécution.',
    '<span class="case-num">06</span> <span class="case-kicker">Welding and rope access · Offshore</span>':
        '<span class="case-num">06</span> <span class="case-kicker">Soudage et travaux sur cordes · Offshore</span>',
    '<span class="case-num">07</span> <span class="case-kicker">Shop fabrication and welding</span>':
        '<span class="case-num">07</span> <span class="case-kicker">Fabrication et soudage en atelier</span>',
    '<span class="case-num">08</span> <span class="case-kicker">Mechanical installation and welding &middot; tank farm</span>':
        '<span class="case-num">08</span> <span class="case-kicker">Montage mécanique et soudage &middot; parc de stockage</span>',
    '<span class="case-num">09</span> <span class="case-kicker">Mechanical installation and welding</span>':
        '<span class="case-num">09</span> <span class="case-kicker">Montage mécanique et soudage</span>',
    '<span class="case-num">10</span> <span class="case-kicker">Mechanical installation</span>':
        '<span class="case-num">10</span> <span class="case-kicker">Montage mécanique</span>',

    # --- careers: five open positions (11.09 handoff) -----------------
    '<i class="position-dot" aria-hidden="true"></i>Hiring now':
        '<i class="position-dot" aria-hidden="true"></i>Recrutement en cours',
    '<span>Positions</span><b>Ongoing recruitment</b>':
        '<span>Positions</span><b>Recrutement continu</b>',
    'MIG / MAG / MMA Welder':
        'Soudeur MIG / MAG / MMA',
    'Pipe Fitter':
        'Tuyauteur',
    ...
    'Piping, root runs and stainless steel systems on shipyard and industrial projects. You weld to an approved procedure, and the fit-up is checked before you start.':
        'Tuyauterie, passes de racine et circuits en acier inoxydable sur des chantiers navals et industriels. Vous soudez selon un mode opératoire approuvé, et l’accostage est contrôlé avant que vous ne commenciez.',
    'Structural steel, fill and capping passes, fabrication in the workshop and repair work on site. Plate, profiles and supports, mostly in shipyards and industrial plants.':
        'Charpente métallique, passes de remplissage et de finition, fabrication en atelier et réparations sur site. Tôles, profilés et supports, surtout en chantiers navals et en installations industrielles.',
    'Spool prefabrication on fitting tables, routing and installation of complete systems, fit-up and alignment before the welder arrives. We work from isometric drawings and 3D models.':
        'Préfabrication de tronçons sur tables d’assemblage, cheminement et montage de circuits complets, accostage et alignement avant l’arrivée du soudeur. Nous travaillons sur plans isométriques et modèles 3D.',
    'You run the crew on site. Planning the sequence, holding the schedule, keeping the safety rules and dealing with the client day to day. You report to our project manager, not to the shipyard.':
        'Vous dirigez l’équipe sur site. Planifier la séquence, tenir le planning, faire respecter les règles de sécurité et traiter au quotidien avec le client. Vous rendez compte à notre chef de projet, pas au chantier naval.',
    'Assembly of hull sections and blocks in the shipyard. Setting plates and profiles, alignment, tack welding and preparing the joints for the welders, on newbuilds and on repair work.':
        'Assemblage de sections et de blocs de coque au chantier naval. Mise en place des tôles et des profilés, alignement, pointage et préparation des joints pour les soudeurs, en construction neuve comme en réparation.',
    'Valid TIG qualification with supporting documents':
        'Qualification TIG valide avec justificatifs',
    'Experience with pipe welding and stainless steel':
        'Expérience en soudage de tuyauterie et en acier inoxydable',
    'Able to work from a welding procedure and an isometric drawing':
        'Capable de travailler d’après un mode opératoire et un plan isométrique',
    'Ready to travel and work on site in several countries':
        'Prêt à voyager et à travailler sur site dans plusieurs pays',
    'Working English, B1 or better':
        'Anglais professionnel, B1 ou mieux',
    'Valid qualification for MAG (135), flux-cored (136) or MMA (111)':
        'Qualification valide pour MAG (135), fil fourré (136) ou MMA (111)',
    'Experience with structural steel and plate work':
        'Expérience en charpente métallique et en tôlerie',
    'Able to read drawings and work to a procedure':
        'Capable de lire des plans et de travailler selon un mode opératoire',
    'Experience with process, utility or engine room piping':
        'Expérience en tuyauterie procédé, utilités ou salle des machines',
    'Able to work from isometrics and 3D models':
        'Capable de travailler d’après des isométries et des modèles 3D',
    'Experience leading welding, piping or mechanical crews on site':
        'Expérience de l’encadrement d’équipes de soudage, de tuyauterie ou de montage sur site',
    'Able to plan the work sequence and report progress to the client':
        'Capable de planifier la séquence des travaux et de rendre compte au client',
    'Confident with safety rules and site documentation':
        'À l’aise avec les règles de sécurité et la documentation de chantier',
    'English at working level, German is an advantage':
        'Anglais professionnel, l’allemand est un atout',
    'Experience with hull assembly on newbuilds or ship repair':
        'Expérience de l’assemblage de coque en construction neuve ou en réparation navale',
    'Able to read shipbuilding drawings':
        'Capable de lire des plans de construction navale',
    'Tack welding and confident use of alignment tools':
        'Pointage et maîtrise des outils d’alignement',
    ...
    '<span>13 pages</span><span>PDF</span><span>2.0 MB</span>':
        '<span>13 pages</span><span>PDF</span><span>2,0 Mo</span>',
    'Who we are, where we operate, the sectors we serve and the standards we work to. Sector capabilities, personnel and certifications.':
        'Qui nous sommes, où nous intervenons, les secteurs que nous servons et les normes selon lesquelles nous travaillons. Capacités par secteur, personnel et certifications.',
    'ISO 9001, 14001 and 45001 certified by DNV &middot; <span class="certs-body">VCA certified by EBN</span>':
        'ISO 9001, 14001 et 45001 certifiés par DNV &middot; <span class="certs-body">VCA certifié par EBN</span>',
    'Certified scope, as stated on the certificates: &ldquo;Inspection and industrial maintenance services for Onshore and Offshore installations.&rdquo;':
        'Périmètre certifié, tel qu’indiqué sur les certificats : &ldquo;Inspection and industrial maintenance services for Onshore and Offshore installations.&rdquo;',
    'Our management systems are certified to ISO 9001, 14001 and 45001 by DNV, and our welding coordination is organised to the requirements of EN ISO 3834-2. Certification means our records are produced under an audited system, so your inspector can rely on them when planning hold and witness points.':
        'Nos systèmes de management sont certifiés ISO 9001, 14001 et 45001 par DNV, et notre coordination en soudage est organisée selon les exigences de l’EN ISO 3834-2. La certification signifie que nos enregistrements sont produits dans un système audité : votre inspecteur peut s’y appuyer pour définir les points d’arrêt et de convocation.',
    'Quality system certified to ISO 9001 by DNV; welding coordination organised to EN ISO 3834-2':
        'Système qualité certifié ISO 9001 par DNV ; coordination en soudage organisée selon EN ISO 3834-2',
    '<strong>Welded, tested, then closed.</strong> Welding coordinated to EN ISO 3834-2. Every joint is documented, and NDT and pressure testing are done before insulation and final coating go on.':
        '<strong>Soudé, éprouvé, puis fermé.</strong> Soudage coordonné selon EN ISO 3834-2. Chaque assemblage est documenté, et le CND et l’épreuve en pression sont réalisés avant la pose du calorifuge et de la finition.',
    'Organised to':
        'Organisé selon',
    'EN ISO 3834-2':
        'EN ISO 3834-2',
    'Welding coordination requirements':
        'Exigences de coordination en soudage',
    'Headquartered in Klaipėda, Lithuania, with project bases in six countries, close to our clients&rsquo; yards, ports and offshore terminals.':
        'Basés à Klaipėda, en Lituanie, avec des bases de projet dans six pays, à proximité des chantiers, des ports et des terminaux offshore de nos clients.',
    'Specialists on our roster':
        'Spécialistes dans notre vivier',
    '<b>200+</b><span>Specialists on our roster</span>':
        '<b>200+</b><span>Spécialistes dans notre vivier</span>',
    'Certified scopes, quoted from the certificates. <b>DNV:</b> &ldquo;Inspection and industrial maintenance services for Onshore and Offshore installations.&rdquo; <b>EBN, VCA* 2026/6.1:</b> &ldquo;Carrying out work on pipelines and metal structures in the Netherlands and Belgium.&rdquo;':
        'Domaines d&rsquo;application certifi&eacute;s, cit&eacute;s des certificats. <b>DNV&nbsp;:</b> &ldquo;Inspection and industrial maintenance services for Onshore and Offshore installations.&rdquo; <b>EBN, VCA* 2026/6.1:</b> &ldquo;Carrying out work on pipelines and metal structures in the Netherlands and Belgium.&rdquo;',
    'ISO 9001, 14001 and 45001 certified by DNV &middot; <span class="certs-body">VCA* certified by EBN</span>':
        'ISO 9001, 14001 et 45001 certifi&eacute;s par DNV &middot; <span class="certs-body">VCA* certifi&eacute; par EBN</span>',
    '<span>Cert. EBN.VCA.12190.1</span><span>Valid to 17.09.2029</span>':
        '<span>Cert. EBN.VCA.12190.1</span><span>Valable jusqu’au 17.09.2029</span>',
    'EBN Certification safety management system certificate — VCA* 2026/6.1, certificate EBN.VCA.12190.1':
        'Certificat de système de management de la sécurité EBN Certification — VCA* 2026/6.1, certificat EBN.VCA.12190.1',
    'Where we did this':
        'Où nous l’avons fait',
    'On independence':
        'Sur l’indépendance',
    'Mechanical, marine and inspection services':
        'Services mécaniques, navals et d’inspection',
    'Mechanical scopes, inspected before we hand them over':
        'Des prestations mécaniques, contrôlées avant remise',
    'Certified people on site, and the inspection records to prove what they did.':
        'Des personnes qualifiées sur site, et les rapports de contrôle qui prouvent ce qu’elles ont fait.',
    'We take mechanical scopes and deliver them with our own supervision. We supply the qualified people a project is short of. On our own scopes we inspect the result ourselves and hand your inspector the records; on work welded by others we act as independent NDT.':
        'Nous prenons en charge des prestations mécaniques et les réalisons sous notre propre encadrement. Nous fournissons les personnes qualifiées qui manquent à un projet. Sur nos propres prestations, nous contrôlons nous-mêmes le résultat et remettons les rapports à votre inspecteur ; sur les soudures réalisées par d’autres, nous intervenons comme END indépendant.',
    'We check welds without cutting or damaging them. Ultrasonic, penetrant and magnetic particle testing can be done while the plant keeps running. Radiography needs the area cleared, so we plan it around production. On our own scopes, our NDT is internal quality control: we find our own defects before your inspector does. On work welded by others, we act as independent NDT and report to the client.':
        'Nous contrôlons les soudures sans les couper ni les endommager. Les contrôles par ultrasons, ressuage et magnétoscopie se font installation en marche. La radiographie exige une zone dégagée : nous la planifions autour de la production. Sur nos propres prestations, notre END est un contrôle qualité interne : nous trouvons nos défauts avant votre inspecteur. Sur les soudures réalisées par d’autres, nous intervenons comme END indépendant et rendons compte au client.',
    'On our own scopes this is internal quality control, and it never counts as sign-off. We wrote down what that means in <a href="/news/we-do-not-certify-our-own-welds.html">we do not certify our own welds</a>.':
        'Sur nos propres prestations, il s’agit d’un contrôle qualité interne, qui ne vaut jamais réception. Nous avons écrit ce que cela signifie dans <a href="/news/we-do-not-certify-our-own-welds.html">nous ne certifions pas nos propres soudures</a>.',
    'Our technicians hold IRATA and SOFT rope access certification and most of them carry a second trade: inspection, welding or mechanical fitting. One person on the rope replaces a scaffold crew and an inspector standing behind them.':
        'Nos techniciens sont certifiés IRATA et SOFT pour les travaux sur cordes et la plupart exercent un second métier : contrôle, soudage ou montage mécanique. Une personne sur corde remplace une équipe d’échafaudage et l’inspecteur derrière elle.',
    'IRATA and SOFT rope access':
        'IRATA et SOFT, travaux sur cordes',
    'Abnormal load permits, escort and cargo securing to EN 12195-1, arranged with our transport partners':
        'Autorisations de transport exceptionnel, escorte et arrimage selon EN 12195-1, organisés avec nos partenaires transport',
    ...
    'Twelve services in three groups -- mechanical and industrial scopes, marine work in yards and afloat, and inspection and access. One contract, one supervisor, one set of records.':
        'Douze services en trois groupes &mdash; prestations mécaniques et industrielles, travaux navals au chantier et à flot, inspection et accès. Un contrat, un encadrement, une documentation.',
    'Enquiries and applications sent from this site are answered from <a href="mailto:info@alprojects.eu">info@alprojects.eu</a>.':
        'Les demandes et les candidatures envoyées depuis ce site sont traitées depuis <a href="mailto:info@alprojects.eu">info@alprojects.eu</a>.',
    '<strong>Plausible Analytics</strong> &mdash; cookieless visit statistics. No cookies, no cross-site tracking and no personal data; we see page addresses, referrers and country, not people.':
        '<strong>Plausible Analytics</strong> &mdash; statistiques de visites sans cookies. Aucun cookie, aucun suivi entre sites et aucune donnée personnelle ; nous voyons des adresses de pages, des sources et un pays, pas des personnes.',
    'ALPROJECTS Group &middot; Value 04':
        'ALPROJECTS Group &middot; Valeur 04',
    '<b>VCA*</b><span>Certified by EBN</span>':
        '<b>VCA*</b><span>Certifié par EBN</span>',
    '12 MM PL':
        '12 MM PL',
    '1 project':
        '1 projet',
    ...
    '<span class="srv-ix-n">01</span> <span class="srv-ix-name">Welding services</span> <span class="srv-ix-proof">3 projects</span>':
        '<span class="srv-ix-n">01</span> <span class="srv-ix-name">Soudage</span> <span class="srv-ix-proof">3 projets</span>',
    '<span class="srv-ix-n">02</span> <span class="srv-ix-name">Pipe fitting</span> <span class="srv-ix-proof">3 projects</span>':
        '<span class="srv-ix-n">02</span> <span class="srv-ix-name">Tuyauterie</span> <span class="srv-ix-proof">3 projets</span>',
    '<span class="srv-ix-n">03</span> <span class="srv-ix-name">Mechanical contracting</span> <span class="srv-ix-proof">3 projects</span>':
        '<span class="srv-ix-n">03</span> <span class="srv-ix-name">Montage mécanique</span> <span class="srv-ix-proof">3 projets</span>',
    '<span class="srv-ix-n">04</span> <span class="srv-ix-name">Heavy equipment relocation</span>':
        '<span class="srv-ix-n">04</span> <span class="srv-ix-name">Transfert d’équipements lourds</span>',
    '<span class="srv-ix-n">05</span> <span class="srv-ix-name">Mobile repair teams</span> <span class="srv-ix-proof">2 projects</span>':
        '<span class="srv-ix-n">05</span> <span class="srv-ix-name">Équipes mobiles de réparation</span> <span class="srv-ix-proof">2 projets</span>',
    '<span class="srv-ix-n">06</span> <span class="srv-ix-name">Shipbuilding</span> <span class="srv-ix-proof">2 projects</span>':
        '<span class="srv-ix-n">06</span> <span class="srv-ix-name">Construction navale</span> <span class="srv-ix-proof">2 projets</span>',
    '<span class="srv-ix-n">07</span> <span class="srv-ix-name">Ship repair</span>':
        '<span class="srv-ix-n">07</span> <span class="srv-ix-name">Réparation navale</span>',
    '<span class="srv-ix-n">08</span> <span class="srv-ix-name">Non-destructive testing</span>':
        '<span class="srv-ix-n">08</span> <span class="srv-ix-name">Contrôle non destructif</span>',
    '<span class="srv-ix-n">09</span> <span class="srv-ix-name">Rope access services</span> <span class="srv-ix-proof">1 project</span>':
        '<span class="srv-ix-n">09</span> <span class="srv-ix-name">Travaux sur cordes</span> <span class="srv-ix-proof">1 projet</span>',
    '<span class="srv-ix-n">10</span> <span class="srv-ix-name">3D laser scanning</span>':
        '<span class="srv-ix-n">10</span> <span class="srv-ix-name">Scanner laser 3D</span>',
    '<span class="srv-ix-n">11</span> <span class="srv-ix-name">Quality assurance and quality control (QA/QC)</span> <span class="srv-ix-proof">3 projects</span>':
        '<span class="srv-ix-n">11</span> <span class="srv-ix-name">Assurance et contrôle qualité (QA/QC)</span> <span class="srv-ix-proof">3 projets</span>',
